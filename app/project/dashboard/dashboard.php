...
$_view->set('probands', \Recapo\Model\Proband::getLastFiveProbandsByProjectID($_project['ID']));
$_view->set('results', \Recapo\Model\Result::getLastFiveResultsByProjectID($_project['ID']));
